...
<div class="custom-calc">
  ...
  <br />
  <center>
    <form name="frmCalc" action="https://www.membersourcecu.org/financial-calculators/amortization/?TYPE=Amortization" method="get" onsubmit="javascript:return ValidateForm(this)">
      <input type="Hidden" name="TYPE" value="Amortization" aria-label="amortization-cal">
...
***********************************************************************************************-->
              ...
              <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#dfeaf9" border="0">
                <tbody>
                        ...
                        <tbody>
                          <tr>
                            <td align="middle" bgcolor="#385a88">
                              <span face="Arial" color="yellow" size="2"><span face="Arial" size="2">Amortization Table<br>
                              Payment = <strong><?php $totalvalue = $_GET['AMOUNT']*(1+$_GET['INTEREST']/100)/($_GET['TERM']*12); echo '$'.$totalvalue; ?> / month</strong>
                              </span></td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <tr>
                    <td align="middle"><span size="2"><span face="ARIAL" color="black"><nobr><strong>Amount<br>
                      <span face="ARIAL" size="2">
                      <input size="9" name="AMOUNT" aria-label="amortization-amount">
                      $</span></strong></nobr></span></span></td>
                    <td align="middle"><span face="ARIAL" color="black" size="2"><nobr><strong>Term<br>
                      <span face="ARIAL" size="2">
                      <input size="9" name="TERM" aria-label="amortization-term">
                      Yrs</span></strong></nobr></span></td>
                  </tr>
                  <tr>
                    <td colspan="2"><hr></td>
                  </tr>
                  <tr>
                    <td align="middle"><span size="2"><span face="ARIAL" color="black"><nobr><strong>Interest 
                      ...
                      <input size="9" name="INTEREST" aria-label="amortization-rate">
                      %</span></strong></nobr></span>
                      <input type="Hidden" name="DOWNPAYMENT" value="0" aria-label="amortization-downpayment">
                      </span></td>
                    <td align="middle"><span color="black">&nbsp;</span></td>
                  </tr>
                  <tr>
                    <td colspan="2"><hr></td>
                  </tr>
      ...
      <tbody>
        <tr>
          <td><table cellspacing="0" cellpadding="2" bgcolor="#dfeaf9">
              <tbody>
                <tr>
                  <td><span face="Arial"><span size="2"><span color="blue"><strong>Help 
                    Information</strong><br>
                    Use this calculator to determine your loan payment's <br>
                    principal and interest components given...</span></span></span></td>
                </tr>
                <tr>
                  <td><span face="Arial"><span size="2">
                    <strong>[AMOUNT]</strong> - The loan 
                    amount</span></span></td>
                </tr>
                <tr>
                  <td><span face="Arial"><span size="2">
                    <strong>[TERM]</strong> - The loan 
                    term</span></span></td>
                </tr>
                <tr>
                  <td><span face="Arial"><span size="2">
                    <strong>[INTEREST]</strong> - The interest rate for the 
                    loan</span></span></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
